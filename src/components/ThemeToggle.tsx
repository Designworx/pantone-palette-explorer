...
export function ThemeToggle() {
  ...
  return (
    <div
      className="relative w-16 h-8 bg-gray-200 dark:bg-gray-700 rounded-full cursor-pointer transition-colors duration-300 ease-in-out"
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-between px-2">
        <svg
          className={`w-4 h-4 text-yellow-600 transition-opacity duration-300 ${
